...
export class AdminserviceService {
  ...
  //#region Banners-Apis
  getBanners(): any {
    return this.http.get('http://194.5.175.25:3005/api/v1/admin/banner');
  }

  addBanner(data: any): any {
    return this.http.post('http://194.5.175.25:3005/api/v1/admin/banner', data);
  }

  editBanner(id: any, data: any): any {
    return this.http.put('http://194.5.175.25:3005/api/v1/admin/banner/' + id, data);
  }

  deleteBanner(id: any): any {
    return this.http.delete('http://194.5.175.25:3005/api/v1/admin/banner/' + id);
  }
  ...
  getSideBanners(): any {
    return this.http.get('http://194.5.175.25:3005/api/v1/admin/sideBanner');
  }

  addSideBanner(data: any): any {
    return this.http.post('http://194.5.175.25:3005/api/v1/admin/sideBanner', data);
  }

  editSideBanner(id: any, data: any): any {
    return this.http.put('http://194.5.175.25:3005/api/v1/admin/sideBanner/' + id, data);
  }

  deleteSideBanner(id: any): any {
    return this.http.delete('http://194.5.175.25:3005/api/v1/admin/sideBanner/' + id);
  }
